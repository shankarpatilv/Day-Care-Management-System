...
import neu.edu.csye6200.userInterface.DisplayStudentJPanel;
...
public class TeacherController {
    ...
    public void deleteTeacher() {
        ...
        if (selectedRow >= 0) {
            ...
            List<Teacher> teachers = TeacherDataManagementFactory.getFactoryInstance().getObject()
                    .getDataList(Integer.parseInt(id));
            if (!teachers.isEmpty()) {
    ...
    public void addTeacher() {
        ...
        teacherJPanel.getAddTeacherJPanel().getBtnAdd().addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                String className = (String) teacherJPanel.getAddTeacherJPanel().getComboBoxClassAssigned()
                        .getSelectedItem();
    ...
    public void setNewTeacherRecord() {
        ...
        teacherJPanel.getAddTeacherJPanel().getTxtEmail().setText("");
        teacherJPanel.getAddTeacherJPanel().getTxtPassword().setText("");
    }
    ...
    // ===============Moin==============================
    public List<Student> getTeacherStudents(Teacher t) {
        List<Student> outStudent = new ArrayList<>();
        ClassRoom c = getClassRoom(t.getClassRoomName());
    ...
    // public void setTeachersStudentRecords(Teacher t){
    // ClassRoom c = getClassRoom(t.getClassRoomName());
    //
    //// ClassRoomController crc = new ClassRoomController(ClassRoomJPanel );
    // List<Student> students = this.getTeacherStudents(t, c);
    //
    //
    //
    //// DisplayStudentJPanel.getUpdateTeacherJPanel().getTxtFieldFName().setText((t.getFirstName()));
    //// DisplayStudentJPanel.getUpdateTeacherJPanel().getTxtFieldLName().setText((t.getLastName()));
    //// String name = t.getIsAssigned()? t.getClassRoomName() : "-";
    //// DisplayStudentJPanel.getUpdateTeacherJPanel().getTextFieldClassRoomAssigned().setText(name);
    //// DisplayStudentJPanel.getUpdateTeacherJPanel().getTextFieldTeacherId().setText((Integer.toString(t.getTeachID())));
    //
    // }
