...
public class StudentController {
        ...
        this.studentJPanel.getUpdateStudentBtn().addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter an integer for id!", "Warning",
                ...
                if (student.isEmpty()) {
                    ...
                    List<Immunization> alert = ImmunizationDataManagementFactory.getFactoryInstance().getObject()
                            .getDataList(id);
                    for (Immunization a : alert) {
                        ...
                        if (exp - (currMonth - month) > 0) {
                            ...
                            studentJPanel.getUpdateStudentJPanel().getAlert()
                                    .append(a.getImmunName() + " due in " + due + " Months" + '\n');
                        }
                    }
                    ...
                    studentJPanel.getUpdateStudentJPanel().getjTextArea2()
                            .append("Renew in " + renew + " Months" + '\n');
        ...
        this.studentJPanel.getUpdateStudentJPanel().getBtnUpdate().addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter an integer for age!", "Warning",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
                Student student = new Student(fName, lName, s.getRegisterTime(), s.getStuId(), Integer.parseInt(age),
                        fatherName, motherName, address, phoneNo, s.getGPA(), s.getEmailid(), s.getPassword());
    ...
    public void updateImmunization() {
        ...
        if (selectedRow >= 0) {
            String immunId = (String) studentJPanel.getUpdateStudentJPanel().getTblImmunInfo().getValueAt(selectedRow,
                    1);
            int studentId = Integer.parseInt(studentJPanel.getTxtFieldStudentId().getText());
            List<Immunization> immuns = ImmunizationDataManagementFactory.getFactoryInstance().getObject()
                    .getDataList(studentId, Integer.parseInt(immunId));
            if (!immuns.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Please select a row from table first to update!", "Warning",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
        studentJPanel.getUpdateStudentJPanel().getUpdateImmunJPanel().getBtnUpdateImmunization()
    ...
    public void updateImmunizationRecord(Immunization i) {
        if (i != null) {
            ...
            String immunName = studentJPanel.getUpdateStudentJPanel().getUpdateImmunJPanel().getTextFieldName()
                    .getText();
            String duration = studentJPanel.getUpdateStudentJPanel().getUpdateImmunJPanel().getTextFieldDuration()
                    .getText();
            ...
            Immunization updated = new Immunization(studentCurrent.getStuId(), Integer.parseInt(id), immunName,
                    duration, dateCorrected, status);
    ...
    public void fillRecordsForImmunization(Immunization i) {
        ...
        studentJPanel.getUpdateStudentJPanel().getUpdateImmunJPanel().getTextFieldId()
                .setText(Integer.toString(i.getImmunId()));
        if (i.isStatus()) {
    ...
    public void addNewImmunization() {
        ...
        studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel().getTextFieldName().setText(m
                .get((String) studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel().getImmId().getSelectedItem()));

        this.studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel().getImmId()
                .addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel().getTextFieldName()
                                .setText(m.get((String) studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel()
                                        .getImmId().getSelectedItem()));

                    }
                });
        studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel().getBtnAddImmunization()
                .addMouseListener(new MouseAdapter() {
                    public void mouseClicked(MouseEvent e) {
                        Date dateCorrected = new Date();
                        String immunName = m.get((String) studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel()
                                .getImmId().getSelectedItem());

                        String duration = studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel()
                                .getTextFieldDuration().getText();
                        String date = studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel().getTextFieldDate()
                                .getText();
                        // String id =
                        // studentJPanel.getUpdateStudentJPanel().getAddImmunJPanel().getTextFieldId().getText();
                        ...
                        Immunization newImmun = new Immunization(studentCurrent.getStuId(), 0, immunName, duration,
                                dateCorrected, status);
    ...
    public void deleteImmunization() {
        ...
        if (selectedRow >= 0) {
            ...
            // if user didn't selected a row show message
            JOptionPane.showMessageDialog(null, "Please select a row from table first to delete!", "Warning",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
    }
    ...
    public void fillImmunizationRecords(Student s) {
        ...
        List<Object> immunizations = ImmunizationDataManagementFactory.getFactoryInstance().getObject()
                .getDataList(s.getStuId());
        ...
        for (Object immun : immunizations) {
            ...
            if (now.getMonthValue() == calendar.get(Calendar.MONTH)
                    && now.getDayOfMonth() == calendar.get(Calendar.DAY_OF_MONTH)) {
    ...
    public void addNewStudent() {
        ...
        this.studentJPanel.getAddStudentJPanel().getBtnAdd().addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                String phoneNo = studentJPanel.getAddStudentJPanel().getTxtPhoneNo().getText();
                String email = studentJPanel.getAddStudentJPanel().getTxtEmail().getText();
                String password = studentJPanel.getAddStudentJPanel().getTxtPassword().getText();
                ...
                if (studentsOfClassRoom(Integer.parseInt(age))) {
                    Student student = new Student(fName, lName, new Date(), 0, Integer.parseInt(age), fatherName,
                            motherName, address, Integer.parseInt(phoneNo), 0, email, password);
    ...
    public void emptyAddJPanel() {
        ...
        studentJPanel.getAddStudentJPanel().getTxtPhoneNo().setText("");
        studentJPanel.getAddStudentJPanel().getTxtEmail().setText("");
    ...
    public Teacher getTeacherFromStudent(Student stud) {
        ...
        List<Student> students = StudentDataMangementFactory.getFactoryInstance().getObject().getDataList(c.getMinAge(),
                c.getMaxAge());
        ...
        return teachers.get((int) counter / 5);
