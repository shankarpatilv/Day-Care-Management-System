...
public class MainController {
  ...
  private void code() {
    ...
    this.view.getBtnRenewal().addMouseListener(new MouseAdapter() {
      public void mouseClicked(MouseEvent e) {
        view.renewalJPanel();
        renewalController = RenewalController.getInstance(view.getRenewalJPanel());
      }
    });
    ...
    this.view.getBtnStateRules().addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        view.getStateRulesjPanel().getAge().addActionListener(new ActionListener() {// add actionlistner to listen for
                                                                                    // change
          @Override
          public void actionPerformed(ActionEvent e) {
